...
{
  private static readonly string Token = "AAHOf0quo22Rqfj_TYuHcYnKO051WMOKYB0";
  ...
  public bool IsValid()
  {
    return TelegramAuthorizationContext.IsValidTelegramMiniAppContext(AuthData, Token, out _);
  }
  
  [Benchmark]
  public bool IsValidSpans()
  {
    return TelegramAuthorizationContextSpan.IsValidTelegramMiniAppContext(AuthData, Token, out _);
  }
}