...
public class TelegramAuthorizationContextValidatorBenchmark
{
  private static readonly string Token = "7888212791:AAHOf0quo22Rqfj_TYuHcYnKO051WMOKYB0";

  private readonly ITelegramAuthorizationContextValidator _validator = new TelegramAuthorizationContextValidator();
  ...
  public bool IsValid()
  {
    return _validator.IsValidTelegramMiniAppContext(AuthData, Token, out _);
  }
}