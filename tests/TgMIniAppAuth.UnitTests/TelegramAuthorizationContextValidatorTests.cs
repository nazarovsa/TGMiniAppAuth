...
public class TelegramAuthorizationContextValidatorTests
{
  ...
  [Fact]
  public void IsValidTelegramMiniAppContext_ValidContextAndToken_ReturnsTrue()
  {
    Assert.True(TelegramAuthorizationContextValidator.IsValidTelegramMiniAppContext(Context, Token, out _));
  }
  ...
  [Fact]
  public void IsValidTelegramMiniAppContext_ValidContextAndToken_ReturnsExpectedDateTimeOffset()
  {
